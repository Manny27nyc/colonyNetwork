...
contract("Contract Storage", (accounts) => {
  ...
  describe("Smoke tests to check our storage layout does not change", () => {
    ...
    it("storage contents should be as expected", async () => {
      ...
      expect(colonyNetworkAccount.stateRoot.toString("hex")).to.equal("62d23508939578e5d48ceeb8655eb292dc8f673a9bd34e1e6730447890bd553e");
      expect(colonyAccount.stateRoot.toString("hex")).to.equal("6ccde00753c913f3a8972aba454cba310404e3cf28e90f7746f2ab844b82821a");
